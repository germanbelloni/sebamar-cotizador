...
export function obtenerVidriosPermitidos({
  ...
  if (ancho <= 100 && alto <= 100) {
    return esModena
      ? ["3mm", "4mm", "5mm", "3+3", "4+4", "DVH 4+9+4", "DVH 5+9+5", "4/6/3+3"]
      : ["3mm", "4mm", "5mm", "3+3", "4+4"];
  }
  ...
  if (ancho <= 200 && alto <= 200) {
    return esModena
      ? ["4mm", "5mm", "3+3", "4+4", "DVH 4+9+4", "DVH 5+9+5", "4/6/3+3"]
      : ["4mm", "5mm", "3+3", "4+4"];
  }
  ...
  if (ancho <= 210 && alto <= 200) {
    return esModena
      ? ["5mm", "3+3", "4+4", "DVH 4+9+4", "DVH 5+9+5", "4/6/3+3"]
      : ["5mm", "3+3", "4+4"];
  }

  // Más grandes
  return esModena
    ? ["3+3", "4+4", "DVH 4+9+4", "DVH 5+9+5", "4/6/3+3"]
    : ["3+3", "4+4"];
}
